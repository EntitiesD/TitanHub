...
public class VanityAccess {
	...
	public static ItemStack unlockStore(ItemStack is)
	{
		...
		newlore.add(" ");
		newlore.add(CC.tnDisable + CC.BOLD + noaccess + CC.RESET + CC.tnDisable + " Not unlocked!");
		newlore.add(CC.tnInfo + "Purchase this at");
		newlore.add(CC.tnValue + "store.TitanCore.com");
		im.setLore(newlore);
		is.setItemMeta(im);
		return is;
	}
	...
	public static ItemStack unlocked(ItemStack is)
	{
		...
		List<String> newlore = im.getLore();
		newlore.add(" ");
		newlore.add(CC.tnEnable + CC.BOLD + access + CC.RESET + CC.tnEnable + " Unlocked!");
		im.setLore(newlore);
		is.setItemMeta(im);
		return is;
	}
	...
	public static ItemStack unlockRank(ItemStack is, Rank rank)
	{
		...
		newlore.add(CC.tnInfo + "Purchase " + r + CC.tnInfo + " rank at" + CC.tnValue + " store.TitanCore.com");
		im.setLore(newlore);
		is.setItemMeta(im);
		return is;
	}
